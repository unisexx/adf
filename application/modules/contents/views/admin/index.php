...
<table class="list">
	<tr>
		...
		<th width="90">
			...
			<a class="btn" href="contents/admin/contents/form/<?=$type?>">เพิ่มรายการ</a>
			<?php endif;?>
		</th>
	</tr>
	...
	<tr <?php echo cycle()?>>
		...
		<td>
			...
			<a class="btn" href="contents/admin/contents/form/<?=$type?>/<?php echo $row->id?>" >แก้ไข</a> 
			<?php endif;?>
			<?php if(permission($type, 'delete')):?>
			<a class="btn" href="contents/admin/contents/delete/<?=$type?>/<?php echo $row->id?>" onclick="return confirm('<?php echo lang('notice_confirm_delete');?>')">ลบ</a>
			<?php endif;?>
		</td>
		</tr>
		<?php endforeach; ?>
